        ...
        try:
            if config["method"] == "GET":
                ...
                async with session.get(api_url) as resp:
                    ...
                    if 'application/json' in content_type or text_res.startswith("{"):
                        try:
                            ...
                            short_link = (
                                ...
                                data.get("result") or
                                (data.get("data") and isinstance(data.get("data"), dict) and (data["data"].get("url") or data["data"].get("shortenedUrl")))
                            )
