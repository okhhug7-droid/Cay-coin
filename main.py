            ...
            if method == "GET":
                ...
                async with session.get(
                    ...
                    if location and location.startswith(("http://", "https://")):
                        if "cloudflare.com/5xx-error-landing" in location.lower():
                            print(f"⚠️ [{service_name}] API trả redirect Cloudflare -> bỏ qua.")
                            return None

                        # API có thể trả link rút gọn trên hostname khác sau khi thay đổi hệ thống.
                        # Chỉ loại redirect Cloudflare; không ép hostname phải là octolink.vip.
                        return location
                    ...
                    try:
                        ...
                        if found:
                            if "cloudflare.com/5xx-error-landing" in found.lower():
                                return None
                            return found
